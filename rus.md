...
Сперва мы зададим плавающему элементу `div` конкретную высоту и ширину для установки системы координат. Мы установим высоту, равную высоте контейнера, которому для этого примера я задала равным высоте вьюпорта, используя единицу измерения `vh`.
